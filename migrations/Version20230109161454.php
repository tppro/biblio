 ...
 */
final class Version20230109161454 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO bookj (id, etat) SELECT id, etat FROM __temp__bookj');
        $this->addSql('DROP TABLE __temp__bookj');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, nom, prenom, date_naissance, rue, codepostal, ville, tel_fix, tel_mobile FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, nom VARCHAR(20) NOT NULL, prenom VARCHAR(20) NOT NULL, date_naissance DATE DEFAULT NULL, rue VARCHAR(255) DEFAULT NULL, codepostal VARCHAR(5) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, tel_fix VARCHAR(15) DEFAULT NULL, tel_mobile VARCHAR(15) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, nom, prenom, date_naissance, rue, codepostal, ville, tel_fix, tel_mobile) SELECT id, email, roles, password, nom, prenom, date_naissance, rue, codepostal, ville, tel_fix, tel_mobile FROM __temp__user');
